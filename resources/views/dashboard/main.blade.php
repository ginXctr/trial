...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="/">Trial</a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link {{ ($title === "Registration") ? 'active' : '' }}" href="Registration" ?>
              <span data-feather="file"></span>
              Registration
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ ($title === "RacePack") ? 'active' : '' }}" href="/RacePack">
              <span data-feather="shopping-cart"></span>
              RacePack
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ ($title === "Members") ? 'active' : '' }}" href="/Members">
